 ...
 */
class Fonds extends \PFF\BourseBundle\Entity\Fonds implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PFF\\BourseBundle\\Entity\\Fonds' . "\0" . 'id', '' . "\0" . 'PFF\\BourseBundle\\Entity\\Fonds' . "\0" . 'historiques', '' . "\0" . 'PFF\\BourseBundle\\Entity\\Fonds' . "\0" . 'montant', '' . "\0" . 'PFF\\BourseBundle\\Entity\\Fonds' . "\0" . 'annee', '' . "\0" . 'PFF\\BourseBundle\\Entity\\Fonds' . "\0" . 'type'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Fonds $proxy) {
